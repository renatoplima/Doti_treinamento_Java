...
public class Exercicio1 {
	...
	public static void main(String[] args) {
		...
		if (diarias > 15) {
			...
			System.out.println("Valor diária imposto  : R$5,50");
			System.out.println("Total das Diárias     : R$"+ total_diarias);
			...
			System.out.println("Hóspede               : "+ nome);
			System.out.println("Valor da Diária       : R$"+ valor_diaria);
			System.out.println("Valor diária imposto  : R$6,00");
			System.out.println("Total das Diárias     : R$"+ total_diarias);
			System.out.println("Total Impostos        : R$"+ imposto);
			System.out.println("Total da conta        : R$"+ total_conta);		
		}
			...
			System.out.println("Hóspede               : "+ nome);
			System.out.println("Valor da Diária       : R$"+ valor_diaria);
			System.out.println("Valor diária imposto  : R$8,00");
			System.out.println("Total das Diárias     : R$"+ total_diarias);
			System.out.println("Total Impostos        : R$"+ imposto);
			System.out.println("Total da conta        : R$"+ total_conta);	
		}
