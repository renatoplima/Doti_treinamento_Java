...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Usuário format  : " + email.substring(0, email.indexOf("@")).toLowerCase());
		...
		System.out.println("1º Caracter     : " + email.charAt(0));
		System.out.println("é igual         ? " + email.equals("RenatoPLima@RenatoPLima.Com.Br"));
